<template>
<view class="content">
	<view class="box" :style='{"padding":"48rpx","boxShadow":"0 0 0px #59f43e","margin":"40rpx auto","backgroundColor":"rgba(243, 243, 243, 0.73)","borderColor":"#ccc","borderRadius":"20rpx","borderWidth":"0","width":"90%","borderStyle":"solid","height":"auto"}'>
		...
		<view class="login-input login-margin-b" :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 0 24rpx","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
			<picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;" @change="optionsChange" :value="index"
			 :range="options">
				<view class="uni-input" :style='{"padding":"0 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"rgba(0, 0, 0, 0)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0 0 4rpx","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'>{{options[index]}}</view>
			</picker>
		</view>
...
<style>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20220301/b72b3657718f474f8ac7a4a8839aa632.png);
