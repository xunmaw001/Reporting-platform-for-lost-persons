<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="案件进度" prop="anjianjindu">
          <el-select :disabled="ro.anjianjindu" v-model="ruleForm.anjianjindu" placeholder="请选择案件进度">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="案件进度" prop="anjianjindu">
	      <el-input v-model="ruleForm.anjianjindu"
                placeholder="案件进度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报备地点" prop="baobeididian">
          <el-input v-model="ruleForm.baobeididian" 
              placeholder="报备地点" clearable  :readonly="ro.baobeididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报备地点" prop="baobeididian">
              <el-input v-model="ruleForm.baobeididian" 
                placeholder="报备地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kouyin = true;
          ...
          if(o=='anjianjindu'){
            this.ruleForm.anjianjindu = obj[o];
	    this.ro.anjianjindu = true;
            continue;
          }
          if(o=='zoushimiaoshu'){
	    ...
	    this.ro.baobeishijian = true;
          ...
          if(o=='baobeididian'){
            this.ruleForm.baobeididian = obj[o];
	    this.ro.baobeididian = true;
            continue;
          }
          if(o=='yonghuming'){
