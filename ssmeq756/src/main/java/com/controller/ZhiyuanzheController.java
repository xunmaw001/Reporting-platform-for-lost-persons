...
public class ZhiyuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody ZhiyuanzheEntity zhiyuanzhe){
    	...
    	ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhanghao", zhiyuanzhe.getZhanghao()));
		if(user!=null) {
